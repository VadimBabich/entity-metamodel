...
/**
 * The mechanical halves of two committed rule sets: the escape-hatch ADR's Tier-S ban, whose
 * package glob is quoted from the ADR so this check cannot drift from the prose, and
 * {@code docs/reactive-code-style.md} §10.1.
 *
...
class ArchitectureRulesTest {
  ...
  private static final JavaClasses PRODUCTION_CLASSES =
      new ClassFileImporter()
          ...
          .importPackages("io.github.vadimbabich.entitymetamodel.runtime.r2dbc");
  ...
  private static final Set<String> OWN_PACKAGES =
      Set.of(
          "io.github.vadimbabich.entitymetamodel.runtime.r2dbc",
          "io.github.vadimbabich.entitymetamodel.runtime");
  ...
  private static final Set<String> ADMITTED_TIER_S_DEPENDENCIES =
      Set.of(
          ...
          "org.springframework.data.relational.core.sql.SelectBuilder$SelectFromAndJoinCondition",
          ...
          "org.springframework.data.relational.core.sql.SelectBuilder$SelectOrdered",
